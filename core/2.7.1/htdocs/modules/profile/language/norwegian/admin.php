...
define('_PROFILE_AM_FIELDNOTCONFIGURABLE', 'Feltet er ikke konfigurerbart.');
define('_PROFILE_AM_ADD', 'Legg til %s');
define('_PROFILE_AM_EDIT', 'Rediger %s');
...
define('_PROFILE_AM_INT', 'Heltall');
...
define('_PROFILE_AM_FLOAT', 'Flytende punkt');
define('_PROFILE_AM_DECIMAL', 'Desimaltall');
define('_PROFILE_AM_UNICODE_ARRAY', 'Unicode-matrise');
define('_PROFILE_AM_UNICODE_EMAIL', 'Unicode-e-post');
define('_PROFILE_AM_UNICODE_TXTAREA', 'Unicode-tekstområde');
define('_PROFILE_AM_UNICODE_TXTBOX', 'Unicode-tekstfelt');
...
define('_PROFILE_AM_TIMEZONE', 'Tidssone');
...
define('_PROFILE_AM_CANNOTDELETEADMIN', 'Sletting av en administratorkonto er ikke tillatt');
...
//1.63
define('_PROFILE_AM_REQUIRED_TOGGLE', 'Veksle obligatorisk felt');
define('_PROFILE_AM_REQUIRED_TOGGLE_SUCCESS', 'Obligatorisk felt endret ');
define('_PROFILE_AM_REQUIRED_TOGGLE_FAILED', 'Endring av obligatorisk felt mislyktes');
define('_PROFILE_AM_SAVESTEP_TOGGLE', 'Veksle lagring');
define('_PROFILE_AM_SAVESTEP_TOGGLE_SUCCESS', 'Lagre etter trinn endret');
define('_PROFILE_AM_SAVESTEP_TOGGLE_FAILED', "Mislyktes ved endring av 'Lagre etter trinn'");
//XOOPS 2.5.9
define('_PROFILE_AM_CANNOTDEACTIVATEWEBMASTERS', 'Du kan ikke deaktivere Webmaster-kontoen');
//XOOPS 2.5.11
define('_PROFILE_AM_EDIT_OPTION_STRINGS', 'Rediger alternativstrenger');
